...
client.on('guildCreate', guild => {
     ...
     .setURL('https://discordapp.com/oauth2/authorize?client_id=400489866573512705&pe')
  .setDescription(`**
...
client.on('guildDelete', guild => {
     ...
     .setColor("GOLD")
     .setTitle('Click Here To Add Bot .!')
     .setURL('This Command Is Not Avaible Right Now..')
  .setDescription(`**
...
client.user.setUsername(argresult).then
    message.channel.sendMessage(`**${argresult}** : Êã ÊÛííÑ ÇáÇÓã Çáì`)
return message.reply("**ÔßÑÇ áÇÓÊÎÏÇãßã ÝÎÑ ÈæÊ ÇÎæßã ÝÑÇÓ . **");
} else
  if (message.content.startsWith(adminprefix + 'setavatar')) {
client.user.setAvatar(argresult);
  message.channel.sendMessage(`**${argresult}** : Êã ÊÛííÑ ÇáÕæÑÉ Çáì`);
      } 
});
...
client.on('message', message => {
   ...
   client.on('message', message => {
        ...
        .setAuthor(` ${message.author.username} `, message.author.avatarURL)      
        .setTitle(`âž¡ Click Here `)
        .setURL(`https://discordapp.com/Soon`)
        .setThumbnail(" https://cdn.discordapp.com/Soon")        
     message.channel.sendEmbed(embed);
       }
   });
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/Soon**")
